...
## Or download the torrent since website is super slow
...
## Unzip (if you use website)
unzip CAT_DATASET_01.zip -d cat_dataset
unzip CAT_DATASET_02.zip -d cat_dataset

## Unzip (if you use torrent)
unzip CAT_00.zip -d cat_dataset
unzip CAT_01.zip -d cat_dataset
unzip CAT_02.zip -d cat_dataset
unzip CAT_03.zip -d cat_dataset
unzip CAT_04.zip -d cat_dataset
unzip CAT_05.zip -d cat_dataset

# Move everything in one single directory
